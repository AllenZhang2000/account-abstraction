...
const FIELD_ORDER = ethers.BigNumber.from(
...
function randBig(n) {
  return toBig(ethers.utils.randomBytes(n));
}
...
const P_PLUS1_OVER4 = ethers.BigNumber.from(
  "0xc19139cb84c680a6e14116da060561765e05aa45a1c72a34f082305b61f3f52"
);
//  const P_MINUS3_OVER4 = ethers.BigNumber.from('0xc19139cb84c680a6e14116da060561765e05aa45a1c72a34f082305b61f3f51');
//  const P_MINUS1_OVER2 = ethers.BigNumber.from('0x183227397098d014dc2822db40c0ac2ecbc0b548b438e5469e10460b6c3e7ea3');
function exp(a, e) {
  let z = ethers.BigNumber.from(1);
  let path = ethers.BigNumber.from(
